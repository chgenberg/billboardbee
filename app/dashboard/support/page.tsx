  ...
  const [tickets, setTickets] = useState<SupportTicket[]>([
    {
      ...
      description: 'Kan inte bekräfta en bokning för Skylt A.',
      status: 'open',
      priority: 'high',
    ...
    {
      id: '2',
      title: 'Fråga om fakturering',
      description: 'Behöver hjälp med att förstå den senaste fakturan.',
      status: 'in-progress',
      priority: 'medium',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-gray-900">Support och ärenden</h1>
