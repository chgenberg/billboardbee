  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: 'Din bokning för Skylt X är nu bekräftad för perioden 1-10 juni.',
      date: '2024-05-25',
      read: false,
    },
    {
      id: '2',
      type: 'warning',
      title: 'Påminnelse: Betalning',
      message: 'Glöm inte att betala din faktura för maj.',
      date: '2024-05-20',
      read: true,
    },
    {
      ...
      type: 'info',
      title: 'Ny funktion!',
      message: 'Nu kan du bjuda in fler till ditt team.',
      date: '2024-05-18',
      read: true,
    },
  ]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-gray-900">Notiser & påminnelser</h1>
        <button
